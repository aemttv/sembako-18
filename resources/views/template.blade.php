...
<head>
    ...
    <script data-cfasync="false" nonce="e2462384-b929-4462-9b27-7f35cfb8e386">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5850";
                        j.zaraz._n = "e2462384-b929-4462-9b27-7f35cfb8e386";
                        j.zaraz.q = [];
...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" :class="{ 'dark bg-gray-900': darkMode === true }">
                            ...
                            <li>
                                ...
                                <div class="translate transform overflow-hidden"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        ...
                                        <li>
                                            <a href="breadcrumb.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="buttons-group.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="cards.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="carousel.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="dropdowns.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="links.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="list.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="modals.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="notifications.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="popovers.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="progress-bar.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="ribbons.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="spinners.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="tabs.html" class="menu-dropdown-item group"
                                        ...
                                        <li>
                                            <a href="tooltips.html" class="menu-dropdown-item group"
                                    ...
                                    <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                        ...
                                        <li>
                                            <a href="two-step-verification.html" class="menu-dropdown-item group"
                                                ...
                                                <span class="absolute right-3 flex items-center gap-1">
                                                    <span class="menu-dropdown-badge"
                                                        :class="page === 'twoStepVerification' ? 'menu-dropdown-badge-active' :
                                                            'menu-dropdown-badge-inactive'">
                                                        Pro
                                                    </span>
                                                </span>
                                    ...
                                    <div>
                                        ...
                                        <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
                                            <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                data-cfemail="0d7f6c63696260787e687f4d7d64606762236e6260">[email&#160;protected]</a>
                                        </span>
                                    </div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015"
        ...
        data-cf-beacon='{"rayId":"930974194900fdc0","version":"2025.3.0","r":1,"token":"67f7a278e3374824ae6dd92295d38f77","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}'
