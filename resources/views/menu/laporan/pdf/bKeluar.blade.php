...
<body>
    ...
    <h1 style="margin: 0; font-size: 22px;">LAPORAN BARANG KELUAR</h1>
</div>
        <div class="container">
        ...
        <table class="pdf-table">
            <thead>
                <tr>
                    <th colspan="9" class="text-center">
                        <strong>Barang Keluar Detail</strong>
                    </th>
                </tr>
                <tr>
                    <th>No.</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <p><span style="font-weight: bold">Total B.Keluar</span>: 
                            <br>
                            {{
                                $bKeluar->sum(function($data) {
                                    return $data->detailKeluar->count();
                                })
                            }} Barang
                        </p>
                    </td>
