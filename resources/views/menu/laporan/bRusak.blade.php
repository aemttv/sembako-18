...
@section('content')
    <div class="p-6 space-y-4">
        ...
        <div
            ...
            <form action="{{ route('laporan.bRusak.search') }}" method="get"
            ...
            <!-- PDF Button Form -->
            <form id="pdfForm" action="{{ route('streamPDF.bRusak.view') }}" method="post"
            ...
            <div class="flex flex-col justify-end w-full sm:w-auto">
                <a href="{{ route('laporan.bRusak.view') }}"
            ...
            <div class="w-full sm:flex-1 sm:flex sm:justify-end">
                <form action="{{ route('laporan.bRusak.search') }}" method="get" class="w-full sm:w-[280px]">
