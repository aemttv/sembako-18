...
@section('content')
    ...
    <div class="flex justify-between items-center gap-2 border rounded-lg p-2 bg-white">
        ...
        <a href="/ajukan-barang-rusak" class="px-4 py-2 text-sm font-medium text-white bg-green-500 rounded-md hover:bg-green-600">Ajukan Barang Rusak</a>
    </div>
    ...
    <div class="border rounded-lg overflow-x-auto">
        <table class="min-w-full text-sm text-left">
            ...
            <tbody class="bg-white divide-y">
                @if($bRusak->isEmpty())
                    <tr>
                        <td colspan="6" class="px-4 py-2 text-center">Tidak ada data barang rusak yang diajukan saat ini..</td>
                    </tr>
                @endif
